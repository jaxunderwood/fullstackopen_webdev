...
sequenceDiagram
    ...
    activate server
    Note right of browser: The browser sends the note data in the request body
    ...
    activate server
    server-->>browser: [{ "content": "HTML is easy", "date": "2023-1-1" }, ..., { "content": "user's new note", "date": "2023-10-27" } ]
    deactivate server
